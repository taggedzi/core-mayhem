...
export const POOLS = {
  ...
  ready: [ready_1, ready_2, ready_3, ready_4],
  ...
  high_damage: [theyre_on_fire, over_the_top, amazing, wow, sick],
  ...
  comeback: [ivenever_seen, this_should_be_good, theyre_on_fire, amazing, wow],
